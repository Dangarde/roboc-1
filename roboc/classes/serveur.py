...
class Serveur:
    ...
    def attendre_connexions(self):
        ...
        while True:
            ...
            for connexion in connexions:
                ...
                self.envoyer_msg_tous(
                    "Connexion du joueur {}".format(nb_clients))

            if nouvelle_connexion and nb_clients >= 2:
                self.envoyer_msg_tous(
                    "{} joueurs sont connectés.".format(nb_clients))
                self.envoyer_msg_tous(
                    "Vous pouvez commencer la partie en tapant 'c'.")
            ...
            try:
                ...
                for client in clients_a_lire:
                    msg = client.recv(self.MSG_LG).decode().rstrip()
    ...
    def envoyer_msg(self, conn, msg):
        ...
        conn.send(msg.ljust(self.MSG_LG).encode())
